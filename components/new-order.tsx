...
import { Trash2, Plus, ArrowLeft, Minus, CalendarIcon } from "lucide-react"
...
// ★ OrderItemInput 型に storageType を追加
type OrderItemInput = {
  productId: string
  quantity: number
  cutType: string
  unit: 'g' | '枚'
  storageType: 'refrigerated' | 'frozen' // 冷蔵 or 冷凍
}
...
const deliveryOptions = [
  ...
  { value: "pickup", label: "店頭受け取り" }, // 店頭受け取りも選択肢に含める
]
...
export default function NewOrder() {
  ...
  // ★ orderItems の初期値に storageType を追加 (デフォルト: 冷蔵)
  const [orderItems, setOrderItems] = useState<OrderItemInput[]>([
    { productId: "", quantity: 0, cutType: "", unit: "g", storageType: "refrigerated" },
  ])
  ...
  // 商品を追加 (storageType のデフォルトも設定)
  const addItem = () => {
    setOrderItems([...orderItems, { productId: "", quantity: 0, cutType: "", unit: "g", storageType: "refrigerated" }])
  }
                      ...
                      <div className="flex items-center space-x-1">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateItem(index, "quantity", isNaN(newValue) || newValue < 1 ? 0 : newValue);
                          }}
                        ...
                        <Select
                          value={item.unit}
                          onValueChange={(value: 'g' | '枚') => updateItem(index, "unit", value)}
                        >
                  ...
                  <div className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div className="w-full md:w-auto flex items-end">
                      <Button
                        ...
                        className={cn(
                          "text-red-500 hover:text-red-700 h-9 w-9",
